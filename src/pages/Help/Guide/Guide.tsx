  ...
  <div className="PageWrapper">
    <div className={styles.HelpSection} id="guide">
          ...
          <tr className={styles.Row}>
            ...
            <td>
              <p className={styles.LegendText}>
                This icon appears next to titles in the transcription workspace. Titles can be plain
                or feature elaborate patterns. Titles often feature ligatures and abbreviations and
                can be much more difficult to read, so don&apos;t worry about them as much early on.
                Type them as a single line.
              </p>
            </td>
          </tr>
          <tr className={styles.Row}>
      ...
      <p className={styles.GuideText}>
        ...
        operating systems and specific computers, but you can find guides for adding Greek keyboards
      ...
      <p className={styles.GuideText}>
        The overall concept is pretty straightforward. Each line of the manuscript, excepting titles
        (see the help icon for those), corresponds to one line of the transcription viewer. Using a
        Greek unicode font, type your answer into the relevant line{' '}
        <b>omitting any accents or punctuation</b>, then click the &quot;Check&quot; button, and you
        should then see one of the symbols listed above.
      </p>
      <p className={styles.GuideText}>
        Most Greek manuscripts do not have spaces, or at least do not use them in the same way as
        modern writers, so there are two ways of completing the lessons. The normal evaluation mode
        does not care whether or not spaces are included, so you can just type the letters as you
        see them on the line. Clicking the &quot;Require spaces&quot; toggle at the top of the
      ...
      <p className={styles.GuideText}>
        Please use the contact form linked in the footer below to report any errors or bugs you have
        found. For errors, please indicate the manuscript and line number. For bugs, please provide
