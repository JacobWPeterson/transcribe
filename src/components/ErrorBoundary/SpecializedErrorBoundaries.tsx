...
export const PDFErrorBoundary = ({
  children,
}: PDFErrorBoundaryProps): ReactElement => (
  <ErrorBoundary
    fallback={
      <div className={classNames(styles.SpecialisedErrorBoundary, styles.PDF)}>
        <h4>PDF Generation Failed</h4>
        <p>
          Unable to generate the lesson report PDF. This might be due to browser
          compatibility issues or large content.
        </p>
        <small>
          Try again or try using a different browser. Contact support if the
          problem persists.
        </small>
      </div>
    }
  ...
  <ErrorBoundary
    fallback={
      ...
      >
        <h4>Storage Error</h4>
        <p>
          Unable to save or load your progress. This might be due to browser
          storage being full or disabled.
        </p>
