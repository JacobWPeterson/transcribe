...
const evaluateSubmission = (
  ...
  if (reformattedGuess.length === reformattedAnswer.length) {
    return [
      reformattedGuess === reformattedAnswer,
      reformattedGuess === reformattedAnswer
        ? "correct"
        : "Answer is incorrect.",
    ];
  ...
  if (reformattedGuess.length < reformattedAnswer.length) {
    return [
      false,
      shortMessage(reformattedAnswer.length - reformattedGuess.length),
    ];
  }
  return [
    false,
    longMessage(reformattedGuess.length - reformattedAnswer.length),
  ];
};
